...
int main()
{
	...
	if (!textureBackGround.loadFromFile("data/PotionCooking/Fond.jpg") || !textureBones.loadFromFile("data/PotionCooking/Os.png") || !textureCauldron.loadFromFile("data/PotionCooking/Chaudron.png") || !textureLadle.loadFromFile("data/PotionCooking/Louche.png") || !textureCup.loadFromFile("data/PotionCooking/Gobelet.png"))
	{
		return EXIT_FAILURE;
	}
